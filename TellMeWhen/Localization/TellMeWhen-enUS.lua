...
TELLMEWHEN_CHOOSENAME_DIALOG = "Enter the name of the spell, ability, item, buff, or debuff you want this icon to monitor";
...
TELLMEWHEN_ICONMENU_TARGETTARGET = "Target of target";
